...
namespace ServiceLocator.Wave
{
    public class WaveService : MonoBehaviour
    {
        ...
        public static WaveService Instance {get{return _instance;}}
        private static WaveService _instance;
        ...
        private void Awake()
        {
            ...
            {
                Destroy(gameObject);
                Debug.LogError("Singleton of WaveService is trying to create another instance.");
            }
        }
